#include "pch.h"
#include "WechatQRDecoder.h"
#include "WechatQRDecoder.g.cpp"
...
{
    int32_t WechatQRDecoder::LoadModel(hstring const& basePath)
    {
	...
	hstring WechatQRDecoder::Decode(int32_t width, int32_t height, array_view<uint8_t const> pixelArray, int32_t channel)
	{
		int type = CV_8UC4;
		switch (channel)
		{
